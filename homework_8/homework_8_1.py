...
#Реализовать класс «Дата», функция-конструктор которого должна принимать данные в виде строки формата «день-месяц-год».
...
class Date:
    ...
    def validate_numbers(numbers: list):
        ...
        assert 1950 <= y <= 2100, "Неверный формат года"
